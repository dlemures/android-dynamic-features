...
class MainActivity : AppCompatActivity() {
    ...
    private val clickListener by lazy {
        View.OnClickListener {
            when (it.id) {
                R.id.btn_load_kotlin -> loadAndLaunchModule(kotlinSampleClassname)
                R.id.btn_load_java -> loadAndLaunchModule(javaSampleClassname)
                R.id.btn_load_native -> loadAndLaunchModule(nativeSampleClassname)
